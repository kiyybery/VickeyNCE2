package cn.ttsk.library.carousel;
...
public class Carousel extends CarouselSpinner implements GestureDetector.OnGestureListener {
	...
	public class CarouselImageAdapter extends BaseAdapter {
		...
		public void SetImages(List<Drawable> drawables, boolean reflected){

			final int reflectionGap = 4;

			mImages = new CarouselItem[drawables.size()];
			for(int i = 0; i< drawables.size(); i++)
			{
				
				Bitmap originalImage = ((BitmapDrawable)drawables.get(i)).getBitmap();
