...
public class Result {
	...
	private static final SparseArray<String> sResultStatus;
	...
	public Result(String outTradeNo, String result) {
		this.mResult = result;
	...
	static {
		sResultStatus = new SparseArray<String>();
	...
	public  void parseResult() {
		...
		try {
			String src = mResult.replace("{", "");
			src = src.replace("}", "");
			resultCode = Integer.parseInt(getContent(src, "resultStatus=", ";memo"));
			resultStatus = sResultStatus.get(resultCode, "其他错误");
