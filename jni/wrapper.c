...
void Java_cn_ttsk_library_LameUtil_initEncoder(JNIEnv *env,
...
void Java_cn_ttsk_library_LameUtil_destroyEncoder(
		JNIEnv *env, jobject jobj) {
	int res = lame_close(lame);
	LOGD("Deinit returned: %d", res);
}

void Java_cn_ttsk_library_LameUtil_encodeFile(JNIEnv *env,
